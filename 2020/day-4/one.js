...
const fields = { mandatory: ['byr', 'iyr', 'eyr', 'hgt', 'hcl', 'ecl', 'pid'], optional: ['cid'] };
...
const isPassportValid = (passport) => {
  ...
  if (keys.length === fields.mandatory.length)
    return !fields.optional.some((optionalField) => keys.includes(optionalField));
