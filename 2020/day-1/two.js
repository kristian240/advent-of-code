...
for (let i = 0; i < input.length - 1; i++) {
  ...
  while (sum !== 2020 - input[i] && high >= low) {
    if (sum < 2020 - input[i]) low++;
    else high--;
  ...
  if (sum === 2020 - input[i]) {
    console.log({
      ...
      two: input[low],
      three: input[high],
      product: input[i] * input[low] * input[high],
    });
